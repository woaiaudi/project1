//
//  SLWSupplyDetail2ViewController.m
//  project1
//
...
#import "UIHelper.h"
@interface SLWSupplyDetail2ViewController ()
{
    GoodsService * goodsService;
}
@end

@implementation SLWSupplyDetail2ViewController
...
-(void)initGoodsInfo{
    ...
    _fenleiLabel.text = goodsBean.fenglei;
...
-(void)initCompanyInfo{
    [goodsService getCompanyByID:goodsBean.addid onsuccess:^(NSDictionary *pBlockDic) {
        ...
        _companyURLLabel.text =[pBlockDic objectForKey:@"_webaddr"];
